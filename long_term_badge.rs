use soroban_sdk::{contracttype, Address, Env, Option, Symbol, Vec};
...
pub struct LongTermBadgeProcessor;

impl LongTermBadgeProcessor {
    ...
    pub fn check_and_award_badge(env: Env, user: Address) {
        let staked_at_key = (Symbol::new(&env, "st_at_lg"), user.clone());
